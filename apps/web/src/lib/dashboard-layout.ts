...
export const EXECUTIVE_DASHBOARD_LAYOUT: LayoutSlot[] = [
  ...
  { widgetId: 'health.mttr', section: 'health', position: 8, width: 3, height: 2, priority: 8, defaultVisible: true, roles: ['noc', 'operations'], refreshIntervalSec: 60, contract: 'HealthWidget' },
