...
check gtm_kit "$ROOT/docs/gtm/README.md"
check gtm_sales "$ROOT/docs/gtm/sales/ENTERPRISE_SALES_PLAYBOOK.md"
check gtm_milestones "$ROOT/docs/gtm/BUSINESS_MILESTONES.md"
